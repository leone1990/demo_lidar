...
//#include "/home/leone/ros-kinetic/src/opencv3/install/include/opencv-3.3.1-dev/opencv2/imgproc/imgproc_c.h"
using namespace std;
using namespace cv;
...
void cvInitUndistortMap( const CvMat* Aarr, const CvMat* dist_coeffs,  
